          ...
          <Card className="bg-yellow-900/20 border-yellow-600/30 backdrop-blur-sm">
            ...
            <CardContent className="space-y-3">
              <p className="text-gray-300">
                Now that you’ve learned what objectives need to be completed by the Outcasts in the game, you can move on to the <a href="/gameFlow"><span className="text-yellow-400 font-semibold">Power & Evolution Card</span></a> section
              </p>
            </CardContent>
          </Card>
        </motion.div>
